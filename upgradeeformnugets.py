...
def main():
    ...
    if int(get_git_status()) > 0:
        ...
        process_repository('ChemicalsBase.csproj', packages, 'chemical-base')
        ...
        if new_number_of_commits > current_number_of_commits:
            ...
            os.chdir("..")
            run_command(f"github_changelog_generator -u microting -p chemical-base -t {os.getenv('CHANGELOG_GITHUB_TOKEN')}", shell=True)
